...
certificates, ancillary tables, and concise proposed OEIS edits are organized by
identifier in the repository \repo.  The principal result classes use the following
paths:
